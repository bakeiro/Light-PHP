...
<div class="row">
	<div class="col s6 left">
		<h5>Controller</h5>
		<img class="welcome" src="site/view/www/src/images/welcome/1.png" alt="">
	</div>
</div>
...
<div class="row">
	<div class="col s6 right">
		<h5>Model</h5>
		<img class="welcome" src="site/view/www/src/images/welcome/2.png" alt="">
	</div>
</div>
...
<div class="row">
	<div class="col s6 left">
		<h5>View</h5>
		<img class="welcome" src="site/view/www/src/images/welcome/3.png" alt="">
	</div>
</div>
...
<div class="row">
	<div class="col s6 right">
		<h5>Route</h5>
		<img class="welcome" src="site/view/www/src/images/welcome/4.png" alt="">
	</div>
</div>
...
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Composer integration</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
...
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Shelf explained code</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Easy structure</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
...
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Console to debug PHP errors</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
...
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Error and warning logs</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
...
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Cache control for CSS/JS files</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
    <span>Minimal template engine</span>
</label>
<br>
<label>
    <input type="checkbox" disabled class="filled-in" checked="checked" />
