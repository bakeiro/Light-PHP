...
Config::set("session_iv", "1K9YlITjUcXxgFwY"); // randomly generated in post install script
Config::set("session_key", "ilaSpsCuBWB5h1e5jESf6Kx8SFAP91N4"); // randomly generated in post install script
