...
Light-php it's a tiny PHP framework, that makes it painless to create web apps. Light-php it's focused to be simple, easy to learn, but enough complete to build your apps. It follows the good coding practices, it's easy to understand and easy to work with a small documentation.
