...
Config::set("session_iv", "ThisIsMySecretIv"); //Replace here by a 16 char string (for encrypt and decrypt session data, ex: openssl_random_pseudo_bytes(16); //16 since openssl_cipher_iv_length('aes-256-cbc')) it's 16
...
//Debug console, enable it with 'true', you can use it to debug messages, and outputting warnings and exceptions
