...
class Session{
	...
	public static function init($cookie = []){
        ...
        //ini_set('session.save_handler', 'files'); //Uncomment here to disable session files
        session_set_save_handler($session_handler, true);
		//session_save_path(SYSTEM . '/writable/sessions'); //Uncomment also here disable session files
